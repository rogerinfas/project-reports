...
Este instrumento fue diseñado y administrado de forma virtual (Google Forms) como diagnóstico inicial para validar la problemática de los tiempos de espera y evaluar la viabilidad de adopción de la plataforma tecnológica TransiGo.
...
Cuestionario administrado de forma virtual a los 20 usuarios participantes del experimento, con el propósito de evaluar la usabilidad, la precisión percibida del sistema TransiGo y validar cualitativamente la reducción de los tiempos de espera.

\begin{enumerate}
    \item \textbf{Sección I: Datos de Identificación}
    \begin{itemize}
        \item ID de Usuario (Asociado al registro del experimento).
    \end{itemize}
    
    \item \textbf{Sección II: Evaluación de la Plataforma TransiGo}
    \begin{itemize}
        \item ¿Considera que el uso de la aplicación TransiGo redujo efectivamente su tiempo de espera en el paradero? (Sí, significativamente; Sí, levemente; No, el tiempo de espera fue el mismo).
        \item En promedio, ¿cuántos minutos estima que ahorró por viaje utilizando la aplicación? (Menos de 5 minutos, Entre 5 y 10 minutos, Entre 10 y 20 minutos, Más de 20 minutos).
        \item ¿Con qué frecuencia logró acudir al paradero de manera sincronizada con la llegada real del bus? (Siempre, Casi siempre, A veces, Casi nunca).
        \item ¿Cómo califica la precisión del tiempo estimado de llegada (ETA) que muestra la aplicación? (Excelente, Buena, Regular, Mala).
        \item ¿El sistema web redujo su nivel de estrés o incertidumbre mientras esperaba el transporte público? (Sí, significativamente; Sí, levemente; No).
        \item ¿Qué funcionalidad de TransiGo le resultó de mayor utilidad práctica? (Visualización del bus en tiempo real en el mapa, Tiempo estimado de llegada - ETA, Localización del paradero más cercano, Trazo de rutas).
        \item ¿Cómo califica la facilidad de uso e interactividad de la interfaz del panel web? (Muy fácil, Fácil, Regular, Difícil).
        \item Califique de manera general su nivel de satisfacción con el sistema implementado: (Escala del 1 al 5: Muy insatisfecho a Muy satisfecho).
