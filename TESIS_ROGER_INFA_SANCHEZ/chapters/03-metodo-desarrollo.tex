...
Para evaluar formalmente el impacto de la plataforma de monitoreo web y tracking GPS sobre el tiempo de espera de los usuarios, se diseñó un experimento en un escenario simulado utilizando la telemetría en tiempo real del sistema. Se contó con un tamaño de muestra $N = 20$ usuarios recurrentes de los corredores del SIT, quienes interactuaron con una simulación del funcionamiento de la plataforma TransiGo basada en trayectos y posiciones GPS de buses en operación. El estudio comparó los tiempos de espera registrados en dos escenarios:
\begin{enumerate}
