...
\begin{itemize}
    \item \textbf{Fuerza de Ventas y Almacén (10 a 12 colaboradores):} Como usuarios directos del POS e inventario \textit{cloud}, se evalúa su nivel de adopción tecnológica y el reemplazo definitivo de los cuadernos físicos. El Encargado de Ventas/Almacén reporta directamente sobre la precisión del registro de salidas.
