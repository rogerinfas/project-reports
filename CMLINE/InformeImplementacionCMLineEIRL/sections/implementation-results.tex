...
Para validar el éxito de la configuración, se proyectan los siguientes indicadores comparando la línea base (Diagnóstico) con la operatividad del sistema Odoo (Tabla \ref{tab:kpis}):
...
A nivel global, el impacto del ERP en \textbf{CM LINE} se refleja en la comparativa que se presenta en la Tabla \ref{tab:comparativa}:
