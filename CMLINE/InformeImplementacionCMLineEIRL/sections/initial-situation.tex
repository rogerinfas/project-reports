...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{imgs/mapa_procesos_inicial.png}
    \caption{Mapa de procesos inicial (Pre-Implementación) evidenciando la fragmentación operativa y las "ventas a ciegas".}
    \label{fig:mapa_procesos_inicial}
\end{figure}
