...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/capacitaciones/sesion-introduccion.png}
    \caption{Sesión de capacitación: introducción al sistema Odoo 19 y objetivos del plan de gestión del cambio.}
    \label{fig:capacitacion_objetivo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/capacitaciones/taller-logistica.png}
    \caption{Taller práctico: gestión logística y ciclo comercial con datos operativos reales de la empresa.}
    \label{fig:capacitacion_metodologia_1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/capacitaciones/capacitacion-pos.png}
    \caption{Capacitación en Punto de Venta (PoS) y control de inventario por códigos de barras.}
    \label{fig:capacitacion_metodologia_2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/capacitaciones/validacion-sprints.png}
    \caption{Despliegue de capacitación integrado con sprints: validación de usabilidad por parte de almacén y ventas.}
    \label{fig:capacitacion_despliegue_1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/capacitaciones/retroalimentacion.png}
    \caption{Retroalimentación en tiempo real durante las sesiones de entrenamiento.}
    \label{fig:capacitacion_despliegue_2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/capacitaciones/autonomia-personal.png}
    \caption{Resultados de la adopción tecnológica: autonomía del personal en el uso del sistema.}
    \label{fig:capacitacion_resultados_1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{imgs/capacitaciones/dominio-guias.png}
    \caption{Consolidación del plan de capacitación: dominio de guías de remisión y flujo logístico-fiscal.}
    \label{fig:capacitacion_resultados_2}
\end{figure}
